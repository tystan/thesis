...
\section[PFDA code]{Pairwise fusion linear discriminant analysis code} \label{PFLDAcode}
	...
	\input{tex/createPFldaobj.tex}

\clearpage

	\input{tex/PFldapredict.tex}
